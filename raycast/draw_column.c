...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/03/19 13:20:46 by jonamart          #+#    #+#             */
/*   Updated: 2026/03/19 13:20:47 by jonamart         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	draw_tex_pixel(t_mlx *mlx, t_texinfo *t)
{
	...
	id = t->c->tex_id;
	w = mlx->tex_width[id];
	tex_y = get_tex_y(t->y, t->c->real_start, t->c->h, mlx->tex_height[id]);
...
void	set_texture_info(t_col *c, t_mlx *mlx, t_dcol *d)
{
	...
	c->tex_x = get_tex_x(mlx->tex_width[c->tex_id], d->side, d->r,
			d->w->wall_x);
}
